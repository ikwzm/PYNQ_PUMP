...
proc create_root_design { parentCell } {
  ...
  if { [string equal [get_property "board_part" [current_project]] ""] == 0 } {
     ...
     set_property -dict [ list CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_M_AXI_GP0 {1} CONFIG.PCW_USE_S_AXI_ACP {1} CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {125.0} ] $processing_system7_0
  } else {
     set import_board_preset [file join [file dirname [info script]] "pynq_revC.tcl"]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x0 [get_bd_addr_spaces pump_axi3_to_axi3_0/I] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x80000000 -offset 0x0 [get_bd_addr_spaces pump_axi3_to_axi3_0/M] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x80000000 -offset 0x0 [get_bd_addr_spaces pump_axi3_to_axi3_0/O] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
